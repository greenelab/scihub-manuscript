...
Sci-Hub is currently served at domains including https://sci-hub.bz and https://sci-hub.tw, as well as at scihub22266oqcxt.onion — a Tor Hidden Service [@url:http://www.dtic.mil/docs/citations/ADA465464].
...
](https://cdn.rawgit.com/greenelab/scihub/ca4d523e149f30be7fd3d3ae6551a26d1c625313/explore/trends/google-trends.png){#fig:history width="100%"}
...
Two weeks later, the domains sci-hub.io, sci-hub.ac, and sci-hub.cc were suspended by their respective domain name registries [@url:http://www.theregister.co.uk/2017/11/23/scihubs_become_inactive_following_court_order/], leaving only the Tor hidden service, sci-hub.bz, and the subsequently-registered sci-hub.tw in operation.
...
](https://cdn.rawgit.com/greenelab/scihub/ca4d523e149f30be7fd3d3ae6551a26d1c625313/figure/coverage-distributions.svg){#fig:distributions width="5in"}
...
We find that as of December 1, 2017, these addresses have received 1,205 donations, totaling ₿94.423 (Figure @fig:bitcoin, Figure @fig:bitcoin-all).
Using the U.S. dollar value at the time of transaction confirmation, Sci-Hub has received an equivalent of $68,159 in bitcoins.
₿81.685 has been withdrawn from the Sci-Hub addresses via 160 transactions.
Since the price of bitcoins has risen, the combined U.S. dollar value at time of withdrawal is $357,487.
On December 1, the Sci-Hub accounts had an outstanding balance of ₿12.738, valued at roughly $150,000.
...
](https://cdn.rawgit.com/greenelab/scihub/ca4d523e149f30be7fd3d3ae6551a26d1c625313/explore/bitcoin/monthly-donations-count.svg){#fig:bitcoin width="100%"}
...
Recent surveys suggest awareness and usage of Sci-Hub is not yet commonplace [@doi:10.1371/journal.pone.0185673; @doi:10.1126/science.aaf5704].
...
Historically, libraries have often canceled individual journal subscriptions or switched from bundled to à-la-carte selections [@doi:10.5062/F4G73BP3; @doi:10.1300/J123v18n01_09; @tag:suny-acs].
...
Negotiations with Elsevier reached impasses in Germany, Peru, and Taiwan, resulting in access outages [@doi:10.1126/science.aal0552; @doi:10.1038/nature.2016.21223; @doi:10.1126/science.355.6320.17;  @doi:10.1038/nature.2017.21482].
...
](https://cdn.rawgit.com/greenelab/scihub/ca4d523e149f30be7fd3d3ae6551a26d1c625313/explore/bitcoin/monthly-donations-faceted.svg){#fig:bitcoin-all tag="S2" width="5in"}
