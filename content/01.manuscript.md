...
Sci-Hub is currently served at domains including `sci-hub.cc` and `sci-hub.io`, as well as at `scihub22266oqcxt.onion` (a Tor Hidden Service [@url:http://www.dtic.mil/docs/citations/ADA465464]).
...
If the coverage of Sci-Hub is widespread, then a significant shift may be underway in how individuals access scholarly literature.
