...
When a pull request is merged, Travis CI performs the build and writes the results to the [`gh-pages`](https://github.com/greenelab/scihub-manuscript/tree/gh-pages) and [`output`](https://github.com/greenelab/scihub-manuscript/tree/output) branches.
